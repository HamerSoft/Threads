...
mkdir -p Packages/com.hamersoft.threads
mv ./Editor Packages/com.hamersoft.threads
mv ./Runtime Packages/com.hamersoft.threads
mv ./Tests Packages/com.hamersoft.threads
mv package.json Packages/com.hamersoft.threads/package.json

touch Packages/manifest.json
json='{
        "dependencies": {
          "com.hamersoft.threads": "file:com.hamersoft.threads",
